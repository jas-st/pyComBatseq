...
def glmFit_DGEList(self, design=None, dispersion=None, prior_count=0.125, start=None, alpha_reg=0, lambda_reg=0):
    """
    ...
    design : matrix, optional
        design matrix for the genewise linear models. Defaults to a single column of ones, 
        equivalent to treating the columns as replicate libraries.
...
def glmFit(
    ...
    #    print("Design matrix is not of full rank. Some coefficients may not be estimable")
